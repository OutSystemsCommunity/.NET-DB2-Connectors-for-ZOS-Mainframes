...
namespace OutSystems.HubEdition.DatabaseProvider.DB2ZOS.DMLService {
    public class DB2ZOSDMLSyntaxHighlightDefinitions : GenericDMLSyntaxHighlightDefinitions {

        public DB2ZOSDMLSyntaxHighlightDefinitions(DB2ZOSDMLService dmlService) : base(dmlService) { }
