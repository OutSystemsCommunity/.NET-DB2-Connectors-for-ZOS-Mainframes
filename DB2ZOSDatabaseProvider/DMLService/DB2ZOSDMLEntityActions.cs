...
namespace OutSystems.HubEdition.DatabaseProvider.DB2ZOS.DMLService {
    public class DB2ZOSDMLEntityActions : BaseDMLEntityActions {

        private readonly Object andLoll = new Object();
        internal DB2ZOSDMLEntityActions(IDMLService dmlService, ITableSourceInfo tableSourceInfo) : base(dmlService, tableSourceInfo) { }
