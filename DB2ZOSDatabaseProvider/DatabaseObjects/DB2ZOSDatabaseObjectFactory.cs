...
namespace OutSystems.HubEdition.DatabaseProvider.DB2ZOS.DatabaseObjects {
    public class DB2ZOSDatabaseObjectFactory : IDatabaseObjectFactory {
        
        // A DB2ZOS piece is any character excluding " and . if not delimited by the literal char, "
        ...
        public DB2ZOSDatabaseObjectFactory(IDatabaseServices databaseServices) {
        ...
        public IDatabaseInfo CreateDatabaseInfo(string databaseIdentifier) {
            ...
            return new DB2ZOSDatabaseInfo(databaseServices, schema);
        }
        ...
        public ITableSourceInfo CreateTableSourceInfo(string qualifiedName) {
            ...
            if (ParseQualifiedTableName(qualifiedName, out schema, out table)) {
                return new DB2ZOSTableSourceInfo(databaseServices, new DB2ZOSDatabaseInfo(databaseServices, schema), table, qualifiedName);
            }
        ...
        public IDatabaseInfo CreateLocalDatabaseInfo() {
            return new DB2ZOSDatabaseInfo(databaseServices, ((DB2ZOSDatabaseConfiguration)databaseServices.DatabaseConfiguration).Schema);
        }
